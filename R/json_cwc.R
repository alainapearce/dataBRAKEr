...
',
    ...
    cwc5 = list( Description = 'Do you ever feel fat?',
                 Levels = list ('1' = 'Never',
                                ...
                                '5' = 'Always',
                                '99' = 'Prefer not to answer')),
    cwc1_scored = list( Description = 'Score scaled to 100 on a 5-point scale'),
    cwc2_scored = list( Description = 'Score scaled to 100 on a 5-point scale'),
    cwc3_scored = list( Description = 'Score scaled to 100 on a 7-point scale'),
    cwc4_scored = list( Description = 'Score scaled to 100 on a 5-point scale'),
    cwc5_scored = list( Description = 'Score scaled to 100 on a 4-point scale'),
...
',
  ...
  # convert formatting to JSON
  cwc_deid_json <- RJSONIO::toJSON(cwc_deid_list, pretty = TRUE)
  
  # double check
  if (isFALSE(RJSONIO::isValidJSON(cwc_deid_json, asText = TRUE))){
    print('CWC JSON file may be invalid')
  }
  
  return(cwc_deid_json)
