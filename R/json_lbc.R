...
json_lbc_deid <- function() {
  ...
  # convert formatting to JSON
  lbc_deid_json <- RJSONIO::toJSON(lbc_deid_list, pretty = TRUE)
  
  # double check
  if (isFALSE(RJSONIO::isValidJSON(lbc_deid_json, asText = TRUE))){
    print('EFCR JSON file may be invalid')
  }
  
  return(lbc_deid_json)
