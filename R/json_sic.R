...
json_sic_deid <- function() {
  ...
  # convert formatting to JSON
  sic_deid_json <- RJSONIO::toJSON(sic_deid_list, pretty = TRUE)
  
  # double check
  if (isFALSE(RJSONIO::isValidJSON(sic_deid_json, asText = TRUE))){
    print('sic JSON file may be invalid')
  }
  
  return(sic_deid_json)
