#' json_foodchoice_events: Generates a json file for the Food Choice events file
#'
...
json_foodchoice_events <- function() {
  
  foodchoice_events_list <- list(
    ...
    left_img_onset = list( Description = 'onset time for left image', 
                           Units = 'sec'),
    right_img_onset = list( Description = 'onset time for right image', 
                            Units = 'sec'),
    choice_prompt_onset = list( Description = 'onset time for choice prompt', 
                                Units = 'sec'),
    key_choice_onset = list( Description = 'onset time for key choice', 
                             Units = 'sec'),
    choice_fix_onset = list( Description = 'onset time for choice fixation', Units = 'sec'),
    left_roi_onset = list( Description = 'onset time for eye-tracking left image region of interest', 
                           Units = 'sec'),
    right_roi_onset = list( Description = 'onset time for eye-tracking right image region of interest', 
                            Units = 'sec'),
    et_record_onset = list( Description = 'onset time for eye-tracking right image region of interest', 
                            Units = 'sec'),
    choice = list( Description = 'participant choice',
                   Levels = list ( '1' = 'left image',
                                   '2' = 'right image',
                                   'None' = 'missing response')),
    choice_rt = list( Description = 'participant choice reaction time', 
                      Units = 'sec'),
    ...
    left_look_onsets = list( Description = 'onset times for each recorded look for the left image region of interest', 
                             Units = 'sec'),
    left_look_offsets = list( Description = 'offset times for each recorded look for the left image region of interest', 
                              Units = 'sec'),
    right_looks = list( Description = 'number of looks recorded for right image region of interest'),
    right_look_onsets = list( Description = 'onset times for each recorded look for the right image region of interest', 
                              Units = 'sec'),
    right_look_offsets = list( Description = 'offset times for each recorded look for the right image region of interest',
                               Units = 'sec'),
    trial_fixprompt_onset = list( Description = 'onset time for fixation', 
                                  Units = 'sec'),
    tfix_onset = list( Description = 'onset time for fixation', 
                       Units = 'sec'),
    trial_fixprompt_offset = list( Description = 'offset time for fixation', 
                                   Units = 'sec'),
    tfix_offset = list( Description = 'offset time for fixation', 
                        Units = 'sec'),
  ...
  foodchoice_events_json <- RJSONIO::toJSON(foodchoice_events_list, pretty = TRUE)
  
  # double check
  if (isFALSE(RJSONIO::isValidJSON(foodchoice_events_json, asText = TRUE))){
    print('foodchoice events JSON file may be invalid')
  }
  
  return(foodchoice_events_json)
