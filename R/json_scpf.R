...
json_scpf_deid <- function() {
  ...
  # convert formatting to JSON
  scpf_deid_json <- RJSONIO::toJSON(scpf_deid_list, pretty = TRUE)
  
  # double check
  if (isFALSE(RJSONIO::isValidJSON(scpf_deid_json, asText = TRUE))){
    print('scpf de-identified JSON file may be invalid')
  }
  
  return(scpf_deid_json)
