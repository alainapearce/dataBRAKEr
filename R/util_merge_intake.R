...
#'
#'
#' @param child_v1_data full set of child visit 1 data generated by util_redcap_child1
#' @param child_v3_data full set of child visit 3 data generated by util_redcap_child3
#' @param proc_de_data full set of processed double-entry data generated by util_redcap_de
#' @examples
#'
#' # process data
#' merged_intake <- util_merged_intake(child_v1_data, child_v3_data, proc_de_data)
#'
#' @seealso [proc_redcap()], [util_redcap_child_v1()], [util_redcap_child_v3()], [util_redcap_de()], [util_calc_intake()]
#'
#' @export
#'


util_merged_intake <- function(child_v1_data, child_v3_data, proc_de_data) {

  liking_all <- rbind.data.frame(child_v1_data$meal_info$data, child_v3_data$meal_info$data)
