#' json_micro_beh: Generates a json file for eah_bites
#'
#' This function generates a json file for eah_bites 
#'
#' @return A json file documenting the Study BRAKE's eah_bites 
#'
#'
#' @export
...
json_micro_beh <- function() {
  ...
  micro_beh_list <- list(
    'MeasurementToolMetadata' = list(
      Description = 'Meal microstructure coding following the extablished protocol for coding bites applied to Eating in the Absence of Hunger',
