...
json_cbq_deid <- function() {
  ...
  # convert formatting to JSON
  cbq_deid_json <- RJSONIO::toJSON(cbq_deid_list, pretty = TRUE)
  
  # double check
  if (isFALSE(RJSONIO::isValidJSON(cbq_deid_json, asText = TRUE))){
    print('cbq JSON file may be invalid')
  }
  
  return(cbq_deid_json)
