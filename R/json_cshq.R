...
json_cshq_deid <- function() {
  ...
  # convert formatting to JSON
  cshq_deid_json <- RJSONIO::toJSON(cshq_deid_list, pretty = TRUE)
  
  # double check
  if (isFALSE(RJSONIO::isValidJSON(cshq_deid_json, asText = TRUE))){
    print('cshq JSON file may be invalid')
  }
  
  return(cshq_deid_json)
